...
console.log(`Exercise 18-1 took ${(endTime - startTime).toPrecision(4)} milliseconds`);

startTime = performance.now();
ex2(process.argv[2]);
endTime = performance.now();
console.log(`Exercise 18-2 took ${(endTime - startTime).toPrecision(4)} milliseconds`);